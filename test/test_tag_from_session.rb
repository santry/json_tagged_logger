...
class TagFromSessionTest < Minitest::Test
  ...
  def test_get_generates_a_multiple_tag_proc
    ...
    JsonTaggedLogger::TagFromSession.stub(:get_values_from_session, ["1234", "ABCD"], [@mock_request, [:user_id, :session_id]]) do
      output = generated_proc.call(@mock_request)
  ...
  def test_get_generates_a_multiple_simple_and_labeled_tag_proc
    ...
    JsonTaggedLogger::TagFromSession.stub(:get_values_from_session, ["val1", "val2", "1234", "ABCD"], [@mock_request, [:tag1, :tag2, :uid, :sid]]) do
      output = generated_proc.call(@mock_request)
